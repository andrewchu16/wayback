...
A React Native Expo app that helps users find the fastest routes using multiple transportation modes (Lime, walking, public transit).
...
- Deep linking to transportation apps (Lime, Apple Maps)
